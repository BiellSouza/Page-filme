function Header () {
    return (
        <header class='flex flex-row justify-between items-center text-lg md:text-4xl'>
            <a href="#"><img class='size-[40px] ml-[5px] mt-[5px] md:size-[100px] md:mt-[15px]' src="./src/assets/Morcegos.png" alt="" /></a>
            <nav className="navigation flex ">
                <ul class='flex flex-row gap-[20px] items-center md:gap-[40px]'>
                    ...
                    <a class='flex mt-[5px] pr-[10px] md:pr-[20px] hover:text-red-700 transition-[0.2s]' href="#"><ion-icon name="search-outline"></ion-icon></a>
