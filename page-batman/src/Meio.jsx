    ...
    return (
        <main class='bg-black'>
            <section class='flex flex-col justify-center text-center'>
                ...
                <div className="btn-box2 flex justify-center mt-[30px] items-center border-2 bg-white ml-[25%] mr-[25%] rounded-[20px] py-[2%] transform scale-100 transition-transform duration-500 hover:scale-110 hover:bg-red-700 hover:border-black hover:font-bold hover:text-white  cursor-pointer ">
